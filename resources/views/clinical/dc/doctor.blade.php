...
@section('title', $pageTitle ?? 'DC - Doctor View')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="alert alert-info border-0 shadow-sm">
            ...
            <strong>DC Doctor View</strong> — This page is under development.
        </div>
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5 text-muted">
                <i class="bi bi-layout-text-window-reverse" style="font-size:4rem; opacity:.2;"></i>
                <h5 class="mt-3">Dental Clinic — Doctor View</h5>
                <p class="mb-0 small">Patient records, treatment charts, and dental notes will appear here.</p>
            </div>
        </div>
    </div>
</div>
