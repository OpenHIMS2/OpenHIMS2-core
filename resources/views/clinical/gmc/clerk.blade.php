...
@section('title', $pageTitle ?? 'GMC - Clerk View')
...
<style>
    ...
    .gmc-card-header { background:#fafbff !important; border-bottom:1px solid #ededf5 !important;
    ...
    .search-wrap .form-control:focus { border-color:var(--c); box-shadow:0 0 0 .2rem rgba(79,70,229,.15); }
    .filter-row .form-select, .filter-row .form-control { font-size:.82rem; border-color:#e2e8f0; }
    .filter-row .form-select:focus, .filter-row .form-control:focus { border-color:var(--c); box-shadow:0 0 0 .2rem rgba(79,70,229,.12); }
    ...
    /* Queue scroll */
    #queue-container { max-height:none; }
    #queue-container > div > div[style*="max-height"]::-webkit-scrollbar { width:4px; }
    #queue-container > div > div[style*="max-height"]::-webkit-scrollbar-thumb { background:var(--c-mid); border-radius:2px; }
    ...
    <div class="d-flex align-items-center justify-content-between position-relative" style="z-index:1;">
        <div class="d-flex align-items-center gap-3">
            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0"
                ...
                <i class="bi bi-person-workspace" style="font-size:1.45rem;color:white;"></i>
            </div>
            <div>
...
(function () {
    ...
    function bindQueueTabs() {
        ...
        // Clerk: queue rows are NOT clickable — no binding needed
    }
