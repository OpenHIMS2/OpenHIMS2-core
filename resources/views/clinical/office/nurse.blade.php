...
@section('title', $pageTitle ?? 'Office - Nurse View')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="alert alert-info border-0 shadow-sm">
            ...
            <strong>Office Nurse View</strong> — This page is under development.
        </div>
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5 text-muted">
                <i class="bi bi-layout-text-window-reverse" style="font-size:4rem; opacity:.2;"></i>
                <h5 class="mt-3">Office — Nurse View</h5>
                <p class="mb-0 small">Nursing records and patient care tasks will appear here.</p>
            </div>
        </div>
    </div>
</div>
